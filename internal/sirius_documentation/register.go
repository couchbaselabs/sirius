...
func (r *Register) RegisteredTasks() map[string]TaskRegister {
	return map[string]TaskRegister{
		...
		"/sub-doc-bulk-insert":  {"POST", &bulk_loading.GenericLoadingTask{}},
		"/sub-doc-bulk-upsert":  {"POST", &bulk_loading.GenericLoadingTask{}},
		"/sub-doc-bulk-delete":  {"POST", &bulk_loading.GenericLoadingTask{}},
		"/sub-doc-bulk-read":    {"POST", &bulk_loading.GenericLoadingTask{}},
		"/sub-doc-bulk-replace": {"POST", &bulk_loading.GenericLoadingTask{}},
