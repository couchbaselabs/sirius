...
//	task.result.Success = task.State.SeedEnd - task.State.SeedStart - task.result.Failure - int64(len(task.State.InsertTaskState.Err)) - int64(len(task.State.RetracePreviousDeletions()))
//
