...
func (r *Request) retracePreviousMutations(collectionIdentifier string, offset int, doc interface{},
	gen docgenerator.Generator, fake *faker.Faker, resultSeed int) (interface{}, error) {
	defer r.lock.Unlock()
	r.lock.Lock()
...
func (r *Request) retracePreviousDeletions(collectionIdentifier string, resultSeed int) (map[int]struct{}, error) {
	defer r.lock.Unlock()
	r.lock.Lock()
...
func (r *Request) retracePreviousFailedInsertions(collectionIdentifier string, resultSeed int) (map[int]struct{},
	error) {
	defer r.lock.Unlock()
	r.lock.Lock()
	result := make(map[int]struct{})
...
func (r *Request) AddToSeedEnd(collectionMetaData *task_meta_data.CollectionMetaData, count int) {
...
func (r *Request) checkAndUpdateSeedEnd(collectionMetaData *task_meta_data.CollectionMetaData, key int) {
	defer r.lock.Unlock()
	r.lock.Lock()
